package com.stark.goodscenter.wighet
...
import com.stark.goodscenter.data.protocal.GoodsSku
...
class GoodsSkuPopView(context: Activity) : PopupWindow(context), View.OnClickListener {
    ...
    private fun initView() {
        ...
        (mRootView.mSkuCountBtn.findViewById(R.id.text_count) as EditText).addTextChangedListener(
                object : TextWatcher{
